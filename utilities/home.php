  ...
  <section>
    <div class="container" data-aos="fade-up">
      <div class="row justify-content-around gy-4 text-center my-4">
        <div
          class="col-lg-4 my-2 d-flex justify-content-center align-items-center"
          data-aos="zoom-in"
          data-aos-delay="100">
          <img
            src="../assets/images/escudo-seminario.png"
            class="img-fluid"
            style="width: 80%"
        ...
        <div class="col-lg-8 d-flex flex-column justify-content-center mt-4">
          <h3 class="my-3 display-6 fw-bold ls-tight m-3">Misión</h3>
          <p>
      ...
      <div class="row justify-content-around gy-4 text-center mb-5">
        <div class="col-lg-12 d-flex flex-column justify-content-center mt-4">
          <h3 class="my-3 display-6 fw-bold ls-tight m-3">Encuéntranos ...</h3>
          <div class="col-lg-8 mx-auto">
            <div class="ratio ratio-16x9">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.7570303004395!2d-73.8363275860141!3d5.602866434736157!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e41c9e6ef25506f%3A0x8c14bfc8c22cba89!2sColegio%20Seminario%20Menor%20Diocesano%20de%20Chiquinquir%C3%A1!5e0!3m2!1ses-419!2sco!4v1653437435079!5m2!1ses-419!2sco"
                style="border:0;"
                allowfullscreen="true"
                aria-hidden="false"
                tabindex="0"
                title="Seminario Ubicación">
              </iframe>
            </div>
          </div>
        </div>
