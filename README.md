...
Aplicativo web realizado en PHP, JavaScript, HTML, y CSS, el cuál se encarga de manejar el control de notas y asistencia de una institución educativa.

Para poder ejecutar el código es necesario importar la base de datos "proyecto.sql" en algún servidor de MySQL y cambiar la configuración de la conexión a la base de datos según sea el caso.
