    ...
    if (isset($_REQUEST['action'])) {
        ...
        if ($action == 'update') {
            ...
            $delete = new Student();
                ...
                $_GET['tdoc_t'], $_GET['id_user_t'], $_GET['id_atte'],
                $_GET['tdoc_atte'], $_GET['stu_course']
            );
        } elseif ($action == 'register') {
            $insert = new Student();
			      $insert ->registerStudent(
                $_POST['tdoc'], $_POST['id_user'], $_POST['id_atte'],
                $_POST['tdoc_atte'], $_POST['stu_course']
            );
        } elseif ($action == 'edit') {
            $tdoc_t = $_GET['tdoc_t'];
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a
              href="?action=edit&tdoc_t=<?php echo $row['pk_fk_tdoc_user'];?>&id_user_t=<?php echo $row['pk_fk_user_id'];?>&id_atte=<?php echo $row['fk_attendant_id'];?>&tdoc_atte=<?php echo $row['fk_attendat_cod_doc'];?>&stu_course=<?php echo $row['fk_cod_course'];?>">
              Update
            </a>
