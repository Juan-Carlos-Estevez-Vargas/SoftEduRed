    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-around gy-4 text-center my-4">
        ...
        <div class="col-lg-8 d-flex flex-column justify-content-center mt-4">
          <h3 class="my-3 display-6 fw-bold ls-tight m-3 text-success">Misión</h3>
          <p>
          ...
          <div class="col-lg-8 mx-auto">
            <div class="ratio ratio-16x9">
              <iframe
                ...
                style="border:0;" allowfullscreen="true" aria-hidden="false" tabindex="0" title="Seminario Ubicación">
              </iframe>
            </div>
          </div>
        </div>
