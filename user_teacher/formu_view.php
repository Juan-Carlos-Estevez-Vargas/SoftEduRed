...
<br><br><br><a href="?action=ver&m=1">NEW RECORD</a><br>
<br><br>
<?php if (!empty($_GET['m']) and !empty($_GET['action']) ) { ?>

<div id="new">
		<form action="#" method="post" enctype="multipart/form-data">
			<br><h2>NEW TEACHER</h2>
			<div id="text">
	        ...
	        <label>Second Name:</label><input id="space" type="text" name="s_name" placeholder="Second Name" >
	        <br><br>
			...
			<label>Answer:</label><input id="space" type="text" name="s_ans" placeholder="Answer" required>
	    	<br><br><br>  	   
...
?>
	...
	<div id="text">
        ...
        <label>Adress:</label>
		<input id="space" type="text" name="adress" value="<?php echo $r['adress'];?>" placeholder="Adress" ><br>
		<br>
		...
		<label>Answer:</label><input id="ans" type="text" name="s_ans" value="<?php echo $r['security_answer'];?>" required>
	</div>
	<br><br>
...
$sql = "SELECT * FROM user JOIN user_has_role ON tdoc_role = pk_fk_cod_doc AND id_user = pk_fk_id_user 
...
<th><a id="boton" href="?action=editar&id_user=<?php echo $row['id_user'];?>&t_doc=
<?php echo $row['pk_fk_cod_doc'] ?>">Update</a>
<a id="boton" href="?action=eliminar&id_user=<?php echo $row['id_user'];?>&t_doc=
<?php echo $row['pk_fk_cod_doc'] ?>" onclick="return confirm('¿Esta seguro de eliminar este usuario?')">Delete</a></th>
 </tr>
<?php endwhile; ?>
 </tbody>
 </table>
