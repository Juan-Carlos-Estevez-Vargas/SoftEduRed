<?php 
	class user_stu_cruds {
		...
		public function registrar($tdoc,$id_user,$f_name,$s_name,$f_lname,$s_lname,$gender,$adress,$email,$phone,$u_name,$pass,$s_ans,$s_ques,$att_doc,$att_id,$course)	{
			...
			$this->pdo->query($sql);
            $sql2 = "INSERT INTO student (pk_fk_tdoc_user,pk_fk_user_id,fk_attendat_cod_doc,fk_attendant_id,fk_cod_course) VALUES ('$tdoc','$id_user','$att_doc','$att_id','$course')";
            $this->pdo->query($sql2);
			$sql3 = "INSERT INTO user_has_role (tdoc_role,pk_fk_id_user,pk_fk_role,state) VALUES ('$tdoc','$id_user','STUDENT',1)";
			$this->pdo->query($sql3);
			print "<script>alert('Registro Agregado Exitosamente.'); window.location='formu_view.php';</script>";
		}

		public function actualizar($tdoc,$id_user,$f_name,$s_name,$f_lname,$s_lname,$gender,$adress,$email,$phone,$u_name,$pass,$s_ans,$s_ques,$att_doc,$att_id,$course) {
			...
			$this->pdo->query($sql);
			$sql2 = "UPDATE student SET fk_attendat_cod_doc = '$att_doc', fk_attendant_id = '$att_id', fk_cod_course = '$course' WHERE pk_fk_tdoc_user = '$tdoc' AND pk_fk_user_id = '$id_user'";
			$this->pdo->query($sql2);
